      ...
      >
        <div class="mr-auto place-self-center lg:col-span-7">
          ...
          >
            ...
            But are we lacking something behind?
          </p>
          <div
            data-aos="fade-up"
          ...
          >
            <div
              class="bg-white p-6 rounded-md border shadow-md flex flex-col items-center justify-center"
            >
...
-----
    ...
    <section class="bg-white dark:bg-gray-900" data-aos="fade-up">
      <div
        class="pt-8 pb-0 px-4 mx-auto max-w-screen-xl lg:pt-16 lg:pb-0 lg:px-6"
      >
        ...
        <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
          ...
          >
            <div class="p-5">
              ...
              <span class="text-gray-500 dark:text-gray-400"
                >We believe in a continuous assessment system that ensures every
                student's progress is monitored closely, allowing us to provide
                personalized feedback tailored to their needs. Our teachers
                offer constructive criticism aimed at helping students recognize
                their strengths and areas for improvement. By prioritizing
                individual growth over mere academic achievement, we instill in
                our students the skills and mindset necessary for lifelong
                learning and success in the ever-evolving
                21st-century landscape.</span
              >
            </div>
          </div>
          <!-- card 2 -->
          ...
          >
            <div class="p-5">
              ...
              <span class="text-gray-500 dark:text-gray-400"
                >We prioritize holistic development, addressing physical,
                mental, emotional, and social well-being. Our programs promote
                physical health, stress relief, and emotional resilience through
                counseling and social skills workshops. Additionally, we
                encourage community engagement through service projects and
                volunteering, empowering students to apply their skills to
                real-world issues and make a positive impact. Through these
                initiatives, we ensure students receive comprehensive support to
                excell academically and personally while becoming active
                contributors to their peer circles.</span
              >
            </div>
          </div>
          <!-- card 3 -->
          ...
          >
            <div class="p-5">
              ...
              <span class="text-gray-500 dark:text-gray-400"
                >Edunext prioritizes the integration of a wide range of life
                skills into the curriculum, recognizing that they encompass
                various facets of daily living. From practical tasks like
                cooking and cleaning to essential financial skills such as
                understanding loans and banking processes, our curriculum aims
                to equip students with the tools they need to thrive in all
                aspects of life. By incorporating these skills into our
                educational framework, we ensure that our students are prepared
                not only for academic success but also for the practical
                challenges they will encounter in adulthood. This comprehensive
                approach empowers students to navigate the complexities of
          ...
          >
            <div class="p-5">
              ...
              <span class="text-gray-500 dark:text-gray-400"
                >At Edunext, we understand that every student is unique, with
                their own strengths, interests, and learning styles. That's why
                we create individualized learning plans for each student,
                tailored to their specific needs. Through comprehensive
                assessments, our teachers identify students' strengths and areas
                for growth, allowing us to customize instruction and resources
                accordingly. This personalized approach enables students to
                progress at their own pace, delve into subjects that captivate
                their interest, and pursue their passions with enthusiasm. By
                empowering students to take ownership of their learning journey,
                we create a sense of autonomy, motivation, and confidence that
                propels them toward academic excellence and personal
                fulfillment.</span
              >
            </div>
          </div>
        ...
        <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
          ...
          >
            <div class="flex flex-col p-5">
              <span class="text-gray-500 dark:text-gray-400"
                >A good review of the students</span
              >
            </div>
    ...
    <h2
      data-aos="fade-up"
      class="mb-4 text-3xl font-extrabold text-center text-gray-900 dark:text-white md:text-4xl"
    >
      Our Supporters
    </h2>
