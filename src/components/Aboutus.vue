<template>
  <div class="container px-5 md:px-28">
    <div class="video-wrapper flex justify-center mb-8" data-aos="fade-up">
      <div>
...
import VerticalSShape from '@/components/VerticalSShape.vue';
...
export default {
  ...
  methods: {
    checkDevice() {
      ...
      this.deviceName = width >= 1024 ? 'desktop' : 'phone';
    },
  },
};
</script>
